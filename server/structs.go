...
var ballots = []ballotStruct{
	...
	{ID: "4", Description: "Do you control your technology or does your technology control you?", Prompts: []promptStruct{
		...
		{ID: "2", Name: "Me", Description: "", Votes: 0},
	}},
	...
	{ID: "11", Description: "Choice 5", Prompts: []promptStruct{
		{ID: "1", Name: "Continue Choreography (move to ankle)", Description: "", Votes: 0},
		{ID: "2", Name: "Blink light", Description: "", Votes: 0},
	}},
	{ID: "12", Description: "Choice 6", Prompts: []promptStruct{
		{ID: "1", Name: "Continue Choreography (lights change color)", Description: "", Votes: 0},
	...
	{ID: "14", Description: "Choice 8", Prompts: []promptStruct{
		{ID: "1", Name: "Continue Choreography (move to hand, then belly)", Description: "", Votes: 0},
		{ID: "2", Name: "Move up leg to belly", Description: "", Votes: 0},
	}},
	{ID: "15", Description: "Choice 9", Prompts: []promptStruct{
		{ID: "1", Name: "Continue Choreography (move back and forth)", Description: "", Votes: 0},
		{ID: "2", Name: "Move to elbow", Description: "", Votes: 0},
	}},
	...
	{ID: "17", Description: "Choice 11", Prompts: []promptStruct{
		{ID: "1", Name: "Continue Choreography (move to belly)", Description: "", Votes: 0},
